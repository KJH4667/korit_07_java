...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        /*
            이상의 코드를 실행시켰을때 알 수 있는 점으로는 어느 공장 객체에서 메서드를 호출했든지 간에 상관없이 createSerialNumber() 메서드를 호출한 결과가 하나로 이루어집니다.
            (싱글톤 때문에). 그래서 다수의 공장 객체에서 각각 produceSmartPhone() 메서드를 호출하더라도 일원화된 시리얼 넘버 부여가 이루어집니다.
            ahah
         */
    }
}
