...
public class TvRemoteController {
    ...
    // 볼륨 버튼 추가하고 나서 AllArgsConstructor 생성하면 Main 에서 오류 발생합니다. 왜?
    // Main 에는 채널버튼 까지의 AllArgsConstructor로 객체가 생성되어 있기 때문에. -> Main 수정하러 가야함
    ...
    //onPressedChannelUpButton() 메서드 / onUpChannelUpButton() 메서드를 구현하시고, Main 에서 실행하여
    // 실행 예
    // 채널을 한 칸 올립니다.
    //채널을 계속 올립니다.
  ...
  public String onUpChannelUpButton1() {
    ...
    public void onUpVolumeUpButton2() {
        System.out.println(volumeDownButton.onUp());
    }
