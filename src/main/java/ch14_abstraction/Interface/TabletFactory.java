...
/*
    ...
    3. TabletFactory의 고유 method인 upgrade(String model) 메서드를 call2() 유형으로 정의하고, 객체명.upgrade("아이패드 프로 13인치 8세대");로 호출하면
    '아이패드 프로 13인치 8세대로 업그레이드 합니다.' 라고 콘솔에 출력될 수 있도록 작성할 것
    4.Main.java로 이동해서
    tabletFactory1 객체를 생성하고, 애플 태블릿 공장이라고 이름 붙일 것
    5. 이름을 구글 태블릿 공장으로 수정할 것 -> getter를 활용하여 현재 공장은 구글 태블릿 공장으로 변경되었습니다. 라고 출력할 수 있도록 작성할 것
    6.객체명.produce("구글 태블릿")을 호출할 것
    7.객체명.manage()를 호출할 것
    8.객체명.upgrade("구글 태블릿 10인치 2세대")을 호출할 것
    ...
    factory2 메서드의 name의 삼성 컴퓨터 공장으로 set 하시오.
