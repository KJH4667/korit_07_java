...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        //저희가 정의한 interface Calculator 를 사용할 겁니다.
        // 근데 인터페이스 내부에는 두개의 매개변수만 정의되어있었습니다.
        ...
        System.out.println(add.calculate(2, 3));    //15번 라인의 주석을 참고했을때의 오랍른 메서드 호출 방식
        ...
        // 근데 add.calculate()는 return x + y 니까, 결과값이 5가 나왔겠네요.
        // 그러면 우리는 24번 코드라인의 해석을 위해서 Calculator 인터페이스와, CalculateMain의 static method와, 그리고 main에서의 lambda식을 전부 왔다갔다 하면서 볼 필요가 있다는 의미가 됩니다.
