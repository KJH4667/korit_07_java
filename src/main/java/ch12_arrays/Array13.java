package ch12_arrays;
/*
    다 차원 배열 (Muti-Dimensional Array) 중에서 2차원 배열

    : 다차원 배열은 2차원 이상의 배열을 의미하지만, 개발 환경 상 2차원 배열 이상을 다루는 경우는 극히 드물기 때문에 2차원 배열을 기준으로 강의합니다.
...
public class Array13 {
    public static void main(String[] args) {
        ...
        for ( int i = 0 ; i < arr03.length; i++ ) {
            //근데 반복문 하나 파고 들어가봐도 여전히 배열이기 때문에 이 부분에서 1차 배열을 추출하기 위한 반복문을 추가로 작성해주셔야 합니다.
