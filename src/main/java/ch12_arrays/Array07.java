package ch12_arrays;
/*
    20250805에 점수 배열의 내부 element 들의 합과 평균을 구할수 있음
    내부 element의 값들의 점수 범위를 조샇여
    90이상은 A
    80이상은 B
    70이상은 C
    60이상은 D
    59이하는 F 인데 ,
    A가 몇명이고,B가 몇명이고... F가 몇 명인지 출력할 수 있도록 할 예정입니다.
...
public class Array07 {
    public static void main(String[] args) {
        ...
        //여러분이 이제 고민할 부분은 -> 어차피 abcdf 가 하나하나 int 니까
